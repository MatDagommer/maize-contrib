...
class Glide(Schrodinger):
    ...
    def run(self) -> None:
        ...
        if self.constraints.is_set:
            ...
            elif "CORE_DEFINITION" in constraints_config.options:  # handle CORE_DEFINITION overide
                if "CORE_DEFINITION" in self.keywords.value.keys() or self.core_definition.changed:
                    # in this case, user set CORE_DEFINITION and it should not be overiden with the constraints file
                    self.logger.warning(
